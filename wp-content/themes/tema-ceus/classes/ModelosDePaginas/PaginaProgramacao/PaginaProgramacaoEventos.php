            ...
            <?php if($evento['tipo_de_eventos'] == 'proxima'): ?>
                <div class="container">
                    <div class="title-ativi">
                        ...
                        <hr>
                        <a href="<?= get_home_url(); ?>/?s=&tipo_atividade=proxima">Ver todas</a>
                    </div>
            ...
            <?php elseif($evento['tipo_de_eventos'] == 'encerrada'): ?>
                <div class="container">
                    <div class="title-ativi">
                        ...
                        <hr>
                        <a href="<?= get_home_url(); ?>/?s=&tipo_atividade=encerrada">Ver todas</a>
                    </div>
                    <div class="row-slide mb-5" style="margin-left: -15px; margin-right: -15px;">
                        <?php
            ...
            <?php elseif($evento['tipo_de_eventos'] == 'perma'): ?>
                ...
                <div class="container">
                    <div class="title-ativi">
                        ...
                        <hr>
                        <a href="<?= get_home_url(); ?>/?s=&tipo_atividade=permanente">Ver todas</a>
                    </div>
