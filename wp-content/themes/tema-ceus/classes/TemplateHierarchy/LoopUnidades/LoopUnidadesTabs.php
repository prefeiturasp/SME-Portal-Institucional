                    ...
                    <?php else: ?>
                        ...
                        <div class="">
                            <div class="title-ativi">
                                ...
                                <hr>
                                <a href="<?= get_the_permalink(); ?>?s=&tipo_atividade=proxima">Ver todas</a>
                            </div>
                            <div class="row-slide mb-5" style="margin-left: -15px; margin-right: -15px;">
                                <?php
                                    $today = date('Ymd');
                                    $id = get_the_ID();
                                    // Proximas Atividades
                        ...
                        <div class="">
                            <div class="title-ativi">
                                <h2>Atividades Permanentes</h2>
                                <hr>
                                <a href="<?= get_the_permalink(); ?>?s=&tipo_atividade=permanente">Ver todas</a>
                            </div>
                        ...
                        <div class="">
                            <div class="title-ativi">
                                ...
                                <hr>
                                <a href="<?= get_the_permalink(); ?>?s=&tipo_atividade=encerrada">Ver todas</a>
                            </div>
                            <div class="row-slide mb-5" style="margin-left: -15px; margin-right: -15px;">
                                <?php
                                    $today = date('Ymd');
