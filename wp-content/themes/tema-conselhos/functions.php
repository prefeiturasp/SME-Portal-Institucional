...
define('__ROOT__', dirname(dirname(__FILE__)).'/tema-conselhos');
...
function remove_normal_excerpt_card() {
    remove_meta_box( 'postexcerpt' , 'card' , 'normal' );
}
add_action( 'admin_menu' , 'remove_normal_excerpt_card' );
 
/**
adiciona a posição para depois do titulo
 */
function add_excerpt_meta_box( $post_type ) {
    if ( in_array( $post_type, array( 'post', 'page', 'card' ) ) ) {
        add_meta_box(
            'oz_postexcerpt',
...
//////////////////////////////////////////////////////////////////
/////////////////remove noticias do admin/////////////////////////
function remove_noticias () 
{
	remove_menu_page('edit.php');//Posts notícias
	//remove_menu_page('edit.php?post_type=page'); // Páginas
	remove_menu_page('edit-comments.php'); // Comentários
} 

add_action('admin_menu', 'remove_noticias');
///////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////
