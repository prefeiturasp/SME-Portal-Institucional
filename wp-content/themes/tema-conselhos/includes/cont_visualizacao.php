...
add_filter( 'manage_edit-card_sortable_columns', 'ws_sortable_manufacturer_column' ); // Card
add_filter( 'manage_edit-agendaconselho_sortable_columns', 'ws_sortable_manufacturer_column' ); // Agenda Conselhos
