<div class="container">
    ...
    <div class="row px-0">
        ...
        <div class="btn-filter-cuida">
            <button type="button" class="btn btn-outline-primary btn-avanc-f btn-avanc btn-avanc-m d-block d-md-none b-0 btn-cuida" data-toggle="modal" data-target="#filtroBusca">
    ...
    <!-- Modal -->
    <div class="modal right fade filter-cuida" id="filtroBusca" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="cuida-filters">
                        ...
                        <div class="filter-list cuida-filter">
                            <?php
                                $terms = get_terms( array(
                                    'taxonomy' => 'categoria-cuida',
                                    'hide_empty' => true,
