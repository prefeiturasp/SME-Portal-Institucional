							...
							while( have_rows('fx_coluna_1_1') ): the_row();
								...
								if( get_row_layout() == 'fx_cl1_titulo_1_1' ):
									...
									echo '<div class="container">';//bootstrap container
										echo '<div class="col-12 mt-4 mb-2 p-0">';
											echo '<div class="title-special d-flex align-items-center justify-content-between">';
												...
												$linecolor = get_sub_field('fx_cor_da_linha_1_1');
												$url = get_sub_field('fx_url_saiba_mais_1_1');

												if($cab_h['value'] == 'h1'){
													echo '<h1 class="text-'.$ali_h['value'].' tx_fx_'.$titlecolor.'" style="color: ' . $titlecolor . '; border-color: ' . $linecolor . '">'.get_sub_field('fx_titulo_1_1').'</h1>';
													if($url && $url != ''){
														echo '<a href="' . $url . '">Ver mais</a>';
													}
													
												}elseif ($cab_h['value'] == 'h2') {
													echo '<h2 class="text-'.$ali_h['value'].' tx_fx_'.$titlecolor.'" style="color: ' . $titlecolor . '; border-color: ' . $linecolor . '">'.get_sub_field('fx_titulo_1_1').'</h2>';
													if($url && $url != ''){
														echo '<a href="' . $url . '">Ver mais</a>';
													}
												}else{
													echo '<h1 class="text-left tx_fx_'.$titlecolor.'">'.get_sub_field('fx_titulo_ style="color: ' . $titlecolor . '; border-color: ' . $linecolor . '"1_1').'</h1>';
								...
								elseif( get_row_layout() == 'fx_cl1_editor_1_1' ): 
									echo '<div class="mt-4 mb-4 container content-block">'.get_sub_field('fx_editor_1_1').'</div>';
										...
										<div class="noticias mt-4 mb-3">
											...
											<div class="row">
												...
												<?php 
													...
													$output = '';													
												?>
													<div class="col-sm-12 col-md-6 <?php echo $colunas; ?>">
								...
								elseif( get_row_layout() == 'fx_fl1_banner_principal_1_1' ):
									...
									$urbanner = get_sub_field('fx_url_botao_1_1'); // url botao									
									
								?>

									<div class="bg-destaque py-5 mb-3">
										<div class="container">
											<div class="row d-flex align-items-center">
												<div class="col-sm-6 text-banner">
													<span class="dest-title"><?php echo $tlbanner; ?></span>
													<?php if($btbanner && $urbanner): ?>
														<a href="<?php echo $urbanner; ?>" class="btn btn-banner"><?php echo $btbanner; ?></a>
													<?php endif; ?>
												</div>
