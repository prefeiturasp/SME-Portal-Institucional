                    ...
                    <div class="row pt-4">
                        <div class="col-sm-12">
                            ...
                            <ul>
                                ...
                                <li>CEU – Fazer inscrição em cursos Uni CEU (<a href="https://sp156.prefeitura.sp.gov.br/portal/servicos/informacao?t=&amp;a=NTgx&amp;conteudo=1146">ir para Fazer inscrição em cursos</a>)</li>
                                    ...
                                    <div id="collapse<?php echo $s; ?>" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                                        <div class="card-body">
                                            ...
                                            <?php if($servico['foto_descricao'] && $servico['foto_descricao'] != ''): 
                                                    $imgurl = wp_get_attachment_image_url( $servico['foto_descricao'], 'thumb-eventos' );
