...
class Cpt
{
	...
	public function __construct($type, $cptSlug, $name, $todosOsItens, $menuName, $singularName, $taxonomy, $taxonomyLabel, $taxonomysingularLabel, $dashborarIcon, array $supports=array('title', 'editor', 'thumbnail', 'excerpt', 'comments'))
	{
		$this->type = $type;
