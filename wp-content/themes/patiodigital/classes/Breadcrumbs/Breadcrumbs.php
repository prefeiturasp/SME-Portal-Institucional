...
namespace Classes\Breadcrumbs;

class Breadcrumbs
{
	public static $numerosDeExibicoes;
	protected $separator = '/';
	protected $breadcrums_id = 'breadcrumbs';
	protected $breadcrums_class = 'breadcrumbs';
	...
	public function the_breadcrumb(){
		...
		if ( !is_front_page() ) {
			...
			echo '<ul id="' . $this->breadcrums_id . '" class="' . $this->breadcrums_class . '">';

			// Home page
			echo '<li class="item-home"><a class="bread-link bread-home" href="' . get_home_url() . '" title="' . $this->home_title . '">' . $this->home_title . '</a></li>';
