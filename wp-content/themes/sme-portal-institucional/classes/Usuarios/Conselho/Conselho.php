...
namespace Classes\Usuarios\Conselho;
...
class Conselho
{
	...
	public function getRole(){
		...
		if (current_user_can('conselho')) {
			$this->role_object = get_role('conselho');
		}
	}
	...
	public function remove_menus(){
		...
		if ($usuario->roles[0] === 'conselho') {
			...
			remove_menu_page('edit.php?post_type=contato'); // Contatos SME
			remove_menu_page('edit.php?post_type=educacao-faq'); // FAQ
