...
namespace Classes\Usuarios\ColabPublicador;

class ColabPublicador
{
	...
	public function getRole(){
		...
		if (current_user_can('publicador')) {
			$this->role_object = get_role('publicador');
		}
	}
