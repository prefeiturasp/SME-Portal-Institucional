...
class CptAgendaDreJt extends Cpt
{
	...
	public function register()
	{
		...
		register_taxonomy(
			...
			$this->cptSlug,
			array(
				"label" => 'Compromissos Jaçana/Tremembé',
				"singular_label" => 'Compromisso',
				"hierarchical" => true,
				'capabilities' => array(
					'manage_terms'	=>	'manage_terms_dre',
					'edit_terms'	=>	'edit_terms_dre',
					'delete_terms'	=>	'delete_terms_dre',
					'assign_terms'	=>	'assign_terms_dre',
				),
				'show_ui' => true,
				'meta_box_cb' => false,
				'query_var' => true,
		...
		register_taxonomy(
			...
			$this->cptSlug,
			array(
				"label" => 'Endereços Jaçana/Tremembé',
