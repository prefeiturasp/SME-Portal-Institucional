...
class CptPages extends Cpt
{
	public function __construct()
	{
		...
		add_filter('manage_edit-page_sortable_columns', array($this, 'tornar_coluna_ordenavel'));
	}
	...
	public function tornar_coluna_ordenavel($columns) {
		$columns['modificado'] = 'modified'; // Use o mesmo nome da coluna
		return $columns;
	}
