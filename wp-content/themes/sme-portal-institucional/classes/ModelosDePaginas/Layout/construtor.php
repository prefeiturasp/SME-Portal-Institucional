		...
		<div class="container-fluid p-0 mb-4">
			<?php
				if(get_field('fx_flex_habilitar_menu') != null || get_field('fx_flex_habilitar_menu', $parent) != null){
					...
					if(!$imagem_banner)
						$imagem_banner = get_field('fx_flex_banner', $parent);//Pega todos os valores da imagem no array
...
<div id="<?php echo $post_slug; ?>" class="<?php echo $container; ?>">
	...
	<div class="row" id="conteudo">
		...
		<div class="<?php echo $coluna; ?>">
			...
			//banner
			if($parent){
				if(get_field('fx_flex_habilitar_banner') != null && get_field('fx_flex_habilitar_menu', $parent) == null ){
					$imagem_banner = get_field('fx_flex_banner');//Pega todos os valores da imagem no array
					echo '<div class="bn_fx_banner"><img src="'.$imagem_banner['url'].'" width="100%" alt="'.$imagem_banner['alt'].'"></div>';
				}
			} else {
				if(get_field('fx_flex_habilitar_banner') != null && get_field('fx_flex_habilitar_menu') == null ){
					$imagem_banner = get_field('fx_flex_banner');//Pega todos os valores da imagem no array
					echo '<div class="bn_fx_banner"><img src="'.$imagem_banner['url'].'" width="100%" alt="'.$imagem_banner['alt'].'"></div>';
				}
			}
				...
				while( have_rows('fx_flex_layout') ): the_row();
									...
									if( have_rows('fx_coluna_1_1') ):
										...
										echo '<div class="col-sm-12 tx_fx_'.$color['value'].'  mt-3 mb-3 col-bt-'.$colorbtn['value'].' ' . $contentClass . '">';//bootstrap col
											while( have_rows('fx_coluna_1_1') ): the_row();
												...
												// Agenda Conselhos
												elseif( get_row_layout() == 'agenda_conselhos' ):
													get_template_part( 'construtor/construtor', 'agenda_conselhos' );
												...
												// Carrossel de Itens
												elseif( get_row_layout() == 'carrossel_itens' ):
													get_template_part( 'construtor/construtor', 'carrossel_itens' );

												// Ultima Atualizacao
												elseif( get_row_layout() == 'ultima_atualizacao' ):
													get_template_part( 'construtor/construtor', 'ultima_atualizacao' );

												// Sorteios Intranet - Ativos
												elseif( get_row_layout() == 'sorteios_ativos' ):
													get_template_part( 'construtor/construtor', 'sorteios_ativos' );

												// Sorteios Intranet - Encerrados (Carrossel)
												elseif( get_row_layout() == 'sorteios_encerrados' ):
													get_template_part( 'construtor/construtor', 'sorteios_encerrados' );

												// Sorteios Intranet - Encerrados (Lista)
												elseif( get_row_layout() == 'sorteios_encerrados_lista' ):
													get_template_part( 'construtor/construtor', 'sorteios_encerrados_lista' );
																			...
																			echo '<div class="col-sm-3 tx_fx_'.$color['value'].'  mt-3 mb-3 col-bt-'.$colorbtn['value'].' ' . $contentClass . '">';//bootstrap col
																				while( have_rows('fx_coluna_1_4') ): the_row();
																					...
																					elseif( get_row_layout() == 'card' ):
																						get_template_part( 'construtor/construtor', 'card' );
									...
									if( have_rows('fx_coluna_1_2') ):
										echo '<div class="col-sm-6 tx_fx_'.$color['value'].'  mt-3 mb-3 col-bt-'.$colorbtn['value']. ' ' . $contentClass . '">';//bootstrap col
											while( have_rows('fx_coluna_1_2') ): the_row();
												...
												// Programacao do CEUs
												elseif( get_row_layout() == 'programa_ceus' ):
													get_template_part( 'construtor/construtor', 'programa_ceus' );
									...
									if( have_rows('fx_coluna_2_2') ):
										echo '<div class="col-sm-6 tx_fx_'.$color['value'].'  mt-3 mb-3 col-bt-'.$colorbtn['value']. ' ' . $contentClass . '">';//bootstrap col
											while( have_rows('fx_coluna_2_2') ): the_row();
												...
												// Bloco Destaque
												elseif( get_row_layout() == 'bloco_destaque' ):
													get_template_part( 'construtor/construtor', 'bloco_destaque' );
						...
						////////////////////////////// Inicio 3/1 Colunas ///////////////////////////////
								elseif( get_row_layout() == 'fx_linha_coluna_3b1' ):
									...
									$estilo_de_colunas = get_sub_field('estilo_de_colunas');
									$ordem_mobile = get_sub_field('ordem');

									if( $estilo_de_colunas == 9 ){
										$contentCol1 = 'col-sm-9';
										$contentCol2 = 'col-sm-3';
									} else {
										$contentCol1 = 'col-sm-8';
										$contentCol2 = 'col-sm-4';
									}
									
									if($ordem_mobile == 'inverso'){
										$contentCol1 = $contentCol1 . ' order-2 order-sm-1';
										$contentCol2 = $contentCol2 . ' order-1 order-sm-2';
									} else {
										$contentCol1 = $contentCol1 . ' order-1 order-sm-1';
										$contentCol2 = $contentCol2 . ' order-2 order-sm-2';
									}
									...
									if( have_rows('fx_coluna_1_3b1') ):
										...
										echo '<div class="' . $contentCol1 . ' tx_fx_'.$color['value'].'  mt-3 mb-3 col-bt-'.$colorbtn['value']. ' ' . $contentClass . '">'; //bootstrap col
											while( have_rows('fx_coluna_1_3b1') ): the_row();
									...
									//conteudo flexivel 2 colunas direita
									if( have_rows('fx_coluna_2_3b1') ):
										echo '<div class="' . $contentCol2 . ' tx_fx_'.$color['value'].'  mt-3 mb-3 col-bt-'.$colorbtn['value']. ' ' . $contentClass . '">'; //bootstrap col
											while( have_rows('fx_coluna_2_3b1') ): the_row();
												...
												elseif( get_row_layout() == 'carrossel_sociais' ):
													get_template_part( 'construtor/construtor', 'carrossel_sociais' );
