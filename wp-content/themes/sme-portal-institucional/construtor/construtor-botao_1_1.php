            ...
            while ( have_rows('fx_botao_1_1') ) : the_row();
                ...
                if( get_row_layout() == 'fx_cl1_botao_1_1' ):
                        ...
                        echo '<div class="col-12 align-' . $align .'">';
                            if($icone){                                
                                echo '<a href="'.get_sub_field('fx_url_botao_1_1').'"><button type="button" class="btn mb-3 bt_fx btn-'.$colorbtn['value'].' btn-lg"><img src="' . $icone . '"> '. get_sub_field('fx_nome_botao_1_1').'</button></a>';
                            } else {
                ...
                if( get_row_layout() == 'fx_cl1_botao_bloco_1_1' ):
                    ...
                    echo '<div class="col-12 text-center">';
                        if($icone){                            
                            echo '<a href="'.get_sub_field('fx_url_botao_1_1').'"><button type="button" class="btn mb-3 bt_fx btn-'.$colorbtn['value'].' btn-lg btn-block"><img src="' . $icone . '"> '. get_sub_field('fx_nome_botao_1_1').'</button></a>';
                        } else {
                ...
                if( get_row_layout() == 'fx_cl1_botao_fixo_1_1' ):
                    ...
                    echo '<div class="col-12 align-' . $align .'">';
                        if($icone){                            
                            echo '<a href="'.get_sub_field('fx_url_botao_1_1').'"><button type="button" class="btn mb-3 bt_fx btn-'.$colorbtn['value'].' btn-lg" style="width: ' . get_sub_field('fx_tamanho_botao_1_1') . 'px;"><img src="' . $icone . '"> '. get_sub_field('fx_nome_botao_1_1').'</button></a>';
                        } else {
