        ...
        echo '<div class="container">';
            ...
            echo '<div class="row">';
                ...
                echo '<div class="col-sm-12">';
                    ...
                    echo '<ul class="card-group nav m-0 acesso-rapido bbb" role="tablist">';
                        ...
                        ?>
                            <li id="tab_<?php echo $acessos['menu']; ?>_<?php echo $i; ?>" class="container-a-icones-home card rounded-0 border-0">
