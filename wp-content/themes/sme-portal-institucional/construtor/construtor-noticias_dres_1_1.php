    ...
    <div class="row">
        <div class="col-sm-12 p-0">
				<?php
                    ...
                    echo '<div class="col-sm-12 lista-noticias-titulo"><p>Notícias das Diretorias Regionais de Ensino (DREs)</p></div>';
                                ...
                                //foreach( $blog_ids as $blog ) :
                                    ...
                                    //if(get_post_thumbnail_id($id)):
                                        ...
                                        if($attachment_image_url == ''){
                                            $attachment_image_url = 'https://educacao.sme.prefeitura.sp.gov.br/wp-content/uploads/2020/08/logotipo-sme.jpg';
                                        }
