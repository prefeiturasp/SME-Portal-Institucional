        ...
        <div class="container">
            <div class="row social-block">
                <div class="col-sm-12 col-md-6">
                    ...
                    <?php if(get_sub_field('fx_fl1_pagina_1_1')): ?>
                        <a href="<?php echo get_sub_field('fx_fl1_pagina_1_1'); ?>"><button type="button" class="btn btn-primary btn-sm px-3 mb-3"><i class="fa fa-youtube-play" aria-hidden="true"></i> | Youtube</button></a>
                    <?php endif; ?>
