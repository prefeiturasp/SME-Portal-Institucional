...
<div class="container">
    ...
    <form class="form-concursos">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="cargos">Cargo/ Função</label>
            ...
            <div class="col-md-4 mb-2">
                <div class="form-group">
                    <label for="ano-hom">Homologação</label>
                    <select class="form-control" name="ano-hom" id="ano-hom">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label for="ano-val">Validade</label>
                    <select class="form-control" name="ano-val" id="ano-val">
                        <option value="">Selecione o ano</option>
                        <?php
