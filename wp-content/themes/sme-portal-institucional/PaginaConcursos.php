	...
	public function montaHtmlConcurso()
	{
        ...
        ?>
            ...
            <div class="shadow-sm col-md-10 p-3 mb-3 bg-white rounded">
                ...
                <form class="needs-validation" novalidate action="<?php echo site_url('/concursos-sme-novo/'); ?>" method="get" id="searchform">
                    <div class="form-row">
            ...
            <div class="col-md-10 mb-5 text-center">
                <h3><a href="?view=lista">Ver todos os concursos SME</a></h3>              
            </div>
        ...
        ?>
            <div class="col-md-12 mt-4 text-atualiza">
                <p class="text-right mb-1">Ultima Atualização: <?php echo get_field( "ultima_atualizacao", 31818); ?></p>
            </div>
        <?php
        ...
        ?>
                <tr>
                    <td class='align-middle'><?php echo get_the_title(); ?></td>
