...
<section class="row cabecalho-acessibilidade">
    <section class="container">
        <section class="row">
            ...
            <article class="col-lg-4 col-xs-12 d-flex justify-content-md-end justify-content-start mb-3">
                    ...
                    <article class="col-12 col-lg-6 col-xs-12 d-flex justify-content-start">
                        <ul class="list-inline menu-outros my-3 d-sm-flex">
                            ...
                            <li class="p-1 border rounded list-inline-item btn-acessibilidade-mobile d-inline-block d-md-none">
                                <i class="fa fa-keyboard-o fa-2x" aria-hidden="true"></i><span class="esconde-item-acessibilidade">(Atalhos Acessíveis)</span>
                            </li>
                        </ul>
                    </article>

                    <article class="col-4 col-lg-6 col-xs-12 d-none d-lg-flex justify-content-end">
                        <?php 
                    ...
                    <div class="col-sm-12 col-md-3 logo-container">
                        ...
                        <form class="d-lg-none">
                            <fieldset>
                                ...
                                <button class="navbar-toggler d-flex" type="button" data-toggle="collapse" data-target="#irmenu" aria-controls="irmenu" aria-expanded="false">
