    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <div id="organograma">            
                ...
                <div id="tree-view4"><p class="title-cons">Colegiados Vinculados</p></div>
        ...
        <?php if($link_unidades != ''): ?>
            <div class="col-sm-12 mt-3">
                <a href="<?php echo $link_unidades; ?>" class="font-weight-bold"><i class="fa fa-university" aria-hidden="true"></i> Consultar Unidades Educacionais </a>
            </div>
        <?php endif; ?>
                            ...
                            <?php 
                                ...
                                if($campos && $campos != ''){
                                    foreach ($campos as $campo){
                                        ...
                                        } elseif($campo['tipo_de_campo'] == 'url'){
                                            echo '<div class="col-sm-12 org-info">
                                                    <span>' . $campo['nome_campo'] . '</span>
                                                    <a href="' . $campo['informacao_campo'] . '">' . $campo['informacao_campo'] . '</a>
                                                    <div class="org-line"></div>
                                                </div>';
                                        } else {
