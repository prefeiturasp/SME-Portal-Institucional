...
<?php
	...
	if($user && $user == '187'){
		$data_recebida_ao_clicar = '20221206';
		$args = array(
			'post_type' => 'agendanew',
			'posts_per_page' => 2,
			'meta_query' => array(
	...
	<div class="container pt-3 pb-3" id="irrodape">
		<div class="row">
			...
			<div class="col-sm-3 align-middle text-center">				
				<a class="sa sat seloa mt-1" href="http://selodigital.imprensaoficial.com.br/validacao/SMPED/011a469daf11991531" target="_blank">
					<img src="<?= STM_THEME_URL ?>/img/sa2.svg" alt="Este sitio possui um selo de acessibilidade digital.">
					<div class="st"><div>Selo de Acessibilidade Digital</div>Nº do Selo: 2025-SAD/022<br>Validade: 28/03/2027<br>Clique para mais informações
					</div>
				</a>
				<p><figure>
...
<div class="voltar-topo d-block d-sm-block d-md-none">
	<a href="#" id="toTop" style="display: none;">
		...
		<p>Voltar ao topo</p>
		<?php /* <img src="https://via.placeholder.com/40x80" alt="" srcset=""> */ ?>
	</a>
</div>
...
<script>
	...
	jQuery( function ( $ ) {
		...
		$("#conteudo a").each(function(){
			...
			if( href && !href.startsWith('#') && !valor.includes('<button') && !valor.includes('<img') && !href.includes('tel:') && !href.includes('mailto:') && !$(this).hasClass( "scroll" ) && !$(this).hasClass( "pagination" ) && !$(this).hasClass( "no-external" ) && !$(this).hasClass( "page-numbers" ) && href != ''){
		...
		$('.check-search').click(function() {
			$('.check-search').not(this).prop('checked', false);
		});
