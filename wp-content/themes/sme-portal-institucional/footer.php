...
<script>
	...
	jQuery( function ( $ ) {
		...
		$("#conteudo a").each(function(){
			...
			if( href && !href.startsWith('#') && !valor.includes('<button') && !valor.includes('<img') && !href.includes('tel:') && !href.includes('mailto:') && !$(this).hasClass( "scroll" ) && !$(this).hasClass( "pagination" ) && !$(this).hasClass( "no-external" ) && href != ''){
