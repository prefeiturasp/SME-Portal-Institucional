                ...
                <article class="col-lg-2 col-xs-12 border-left mb-xs-4">
                    ...
                    <ul class="list-inline mb-3">
                        <li class="list-inline-item">
                            <a class="text-white" href="https://www.facebook.com/PrefSP/">
                                <img src="<?= STM_URL ?>/wp-content/uploads/2019/09/icone-facebook-topo.png" alt="Ir para Facebook da Prefeitura de São Paulo">
                            </a>
                        </li>

                        <li class="list-inline-item">
                            <a class="text-white" href="https://www.instagram.com/prefsp/">
                                <img src="<?= STM_URL ?>/wp-content/uploads/2019/09/icone-instagram-topo.png" alt="Ir para Instagram da Prefeitura de São Paulo">
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a class="text-white" href="https://twitter.com/prefsp/">
                                <img src="<?= STM_URL ?>/wp-content/uploads/2019/09/icone-twitter-topo.png" alt="Ir para Twitter da Prefeitura de São Paulo">
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a class="text-white" href="https://www.youtube.com/user/prefeiturasaopaulo">
                                <img src="<?= STM_URL ?>/wp-content/uploads/2019/09/icone-youtube-topo.png" alt="Ir para YouTube da Prefeitura de São Paulo">
                            </a>
                        </li>
                    </ul>
                    <ul class="list-inline mb-3">
