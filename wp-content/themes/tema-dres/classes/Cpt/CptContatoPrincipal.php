...
class CptContatoPrincipal extends Cpt{
	...
	public function register(){
        ...
        $args = array(
            ...
            'query_var' => true,
            'rewrite' => true,
			'capability_type' => array('contatoprincipal','contatoprincipals'),
			'capabilities' => array(
				'edit_post' => 'edit_contatoprincipal',
				'edit_posts' => 'edit_contatoprincipals',
				'edit_published_posts ' => 'edit_published_contatoprincipals',
				'read_post' => 'read_contatoprincipal',
				'read_private_posts' => 'read_private_contatoprincipals',
				'delete_post' => 'delete_contatoprincipal',
				'delete_published_posts' => 'delete_published_contatoprincipals',
			),
			'map_meta_cap'        => true,
            'has_archive' => true,
            'hierarchical' => false,
