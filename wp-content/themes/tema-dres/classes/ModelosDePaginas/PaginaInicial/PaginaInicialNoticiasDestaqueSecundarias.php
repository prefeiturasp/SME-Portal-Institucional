			...
			?>
				<article class="row mb-4 b-home border-bottom">
					<div class="col-12 col-md-5 mb-1">
						<img class="img-fluid rounded float-left mr-4 img-noticias-destaques-secundarias desc2-img-home" src="<?php echo get_the_post_thumbnail_url( $p->ID, 'default-image' ); ?>" alt="">
					</div>
				...
				<?php else: 
					...
					while ( have_posts() ) : the_post(); ?>
						...
						<article class="row mb-4 b-home border-bottom">
							<div class="col-12 col-md-5 mb-1">
								<img class="img-fluid rounded float-left mr-4 img-noticias-destaques-secundarias desc2-img-home" src="<?php echo get_the_post_thumbnail_url('default-image'); ?>" alt="">
							</div>
							<div class="col-12 col-md-7">
								<h3 class="fonte-catorze font-weight-bold">
