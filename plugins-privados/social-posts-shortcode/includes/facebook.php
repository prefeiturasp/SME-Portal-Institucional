...
function render_facebook_posts($atts) {
    ...
    $alt = !empty($post['message']) ? esc_attr($post['message']) : 'Imagem do Facebook';
    $html .= $img ? "<a href=\"$link\" target=\"_blank\"><img src=\"" . esc_url($img) . "\" alt=\"$alt\" style=\"max-width:100%;height:auto;\" /></a>" :
