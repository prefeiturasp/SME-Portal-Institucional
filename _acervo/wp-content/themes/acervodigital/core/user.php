...
if($user_teste = true){
	...
	add_role('teste_user1', __(//Role name
	   ...
	   array(
		   ...
		   //uploads
		   'upload_files' => true, //permite upload de arquivos
...
//Bloco painel personalizado
if(current_user_can('teste_user1')) {
	function add_dashboard_widget()
	{
		wp_add_dashboard_widget("relatorio-teste", "Relatório", "display_rss_dashboard_widget");
	}

	function display_rss_dashboard_widget(){
		echo 'conteudo modificado';
	}
